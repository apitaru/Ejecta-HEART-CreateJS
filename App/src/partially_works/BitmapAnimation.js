/*
Partially works, I had to remove the SpriteSheetUtils portions of the code. 
A lot of work needs to go into the SpriteSheetUtils because we can't resize canvases yet.
*/
